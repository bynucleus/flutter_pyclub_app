...
class _AboutPageState extends State<AboutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Fluttertoast.showToast(msg: "impossible d'ouvrir le lien : " + "https://nucleus.eblackci.com");
    // throw 'Could not launch link';
  }
                              },
                              child:  Text("@nucleus",style: TextStyle(color: Colors.blue),)),
                          ),   
                          SizedBox(
                            height: 100,
                          ),
                          ...
                          Center(
                              child: Text(
                            "\nCopyright ©2022 Nucleus, Tous droits réservés ! ! ",
                            style: TextStyle(
                                fontSize: 10.0, ),
                          )),                       
                        ])
